              ...
              <div class="card-body">
                <form method="POST" action="{{ route('artikel.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" placeholder="Masukkan Judul Artikel" name="title">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="example-date-input" class="col-md-2 col-form-label form-control-label">Tanggal</label>
                    <div class="col-md-10">
                      <input class="form-control" type="date" placeholder="2022-05-29" name="date">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-md-2 col-form-label form-control-label" for="exampleFormControlTextarea2">Deskripsi</label>
                    <div class="col-md-10">
                      <textarea class="form-control" name="description" rows="3" resize="none"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="url" placeholder="https://www.creative-tim.com/" name="url">
                    </div>
                  </div>
