        ...
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form method="POST" action="{{ route('user.transaksi.store') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="total" value="{{ $obat->price }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    <li>{{ $obat->obat }} <span>Rp. {{ $obat->price }}</span></li>
                                </ul>
                                <div class="checkout__order__subtotal">Total <span>Rp. {{ $obat->price }}</span></div>
